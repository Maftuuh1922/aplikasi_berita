...
import '../services/auth_service.dart';          // hanya 1 sumber AuthService
import 'verifikasi_email_screen.dart' show VerifikasiEmailScreen; // ekspor yg dipakai saja
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _handleEmailRegister() async {
    ...
    try {
      final ok = await _authService.registerWithEmailAndPassword(
      ...
      if (ok) {
        ...
        // arahkan user ke layar cek‑email
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (_) => const VerifikasiEmailScreen()),
        );
      } else {
        _showSnack('Pendaftaran gagal. Silakan coba lagi.');
      }
    } catch (e) {
